import type { PomodoroAction, PomodoroState } from './tomato-timer-types'
...
export const pomReducer = (state: PomodoroState, action: PomodoroAction) => {
  switch (action.type) {
    case 'START_TIMER':
      return {
        ...state,
    ...
    case 'SUBTRACT_MINUTE':
      return {
        ...state,
        minutes: state.minutes && state.minutes - 1,
        seconds: 59,
      }
    case 'BREAK_TIME':
      return {
